...
// ==========================================
// O TRADUTOR DO SUMÁRIO (ATUALIZADO)
// ==========================================
const dicionarioDeTelas = {
    'pag-3': 4,               // Boas-Vindas e Missão
    'pag-5': 6,               // Economia Doma
    'pag-7': 8,               // O Monstrinho Interno
    'pag-8': 9,               // A Travessia
    'pag-10': 11,             // Imersão Total
    'pag-capitulo-1': 12,     // O Acolhimento
    'pag-mecanica-mente': 16, // Mecânica da Mente
    'pag-intro-darkmode': 18, // Laboratório
    'pag-26': 20,             // O Papel de Pão
    'slide-intro-1': 21,      // Triagem
    'pag-tribunal-intro': 23  // O Tribunal Interno
};
...
window.irParaTela = function(idAlvo) {
    ...
    // TRAVA JAVASCRIPT: Impede clicar em itens não alcançados (exceto os abertos por padrão)
